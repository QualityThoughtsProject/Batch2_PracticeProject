...
public class CreateVehiclesTrailer extends CommonMethods{
		
	WebDriver driver;
	
	@FindBy(xpath="(//*[@id='PersAutoLineBusiness.PersVeh.ACIC_VehSubTypeCd']") private static WebElement clienTrailerType;
	...
	@FindBy(xpath="(//*[@id='PersAutoLineBusiness.PersVeh.ACIC_StatedValue.FormatInteger']") private static WebElement clienStatedAmount;
	...
	CreateVehiclesTrailer(WebDriver driver){
		this.driver=driver;
